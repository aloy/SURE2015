...
shinyUI(bootstrapPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      conditionalPanel(
        "$('li.active a').first().html()==='Full Model'",
      ...
      conditionalPanel(
        ...
        radioButtons("check", label=h4("Diagnostics"), c("Non-Collinearity" = "mult", "Linearity" = "line", 
                             "Leverage" = "lev", "Constant Variance" = "var", "Normal Errors" = "norm"), selected="mult")
      )
      ), #sidebar Panel
    mainPanel(
